      ...
      <main className="h-screen bg-white px-10 mobile:px-2 text-center  dark:bg-gray-800">
        <div className="flex  items-center justify-center h-screen ">
          <section className="flex flex-col gap-10 md:gap-3 sm:gap-3 mobile:gap-4 md:flex-row px-10 lg:mt-64 md:mt-48 sm:mt-64 mobile:mt-28 sm:px-2 mobile:px-2  ">
            ...
            <div className="flex items-center justify-center mr-10 md:w-1/2 sm:w-4/5 relative  mx-auto mobile:px-5 mobile:mr-2 lg:mt-1 sm:mb-80 lg:px-10  rounded-3xl sm:rounded-3xl md:rounded-3xl mobile:rounded-3xl shadow-2xl bg-neutral-950 dark:shadow-white dark:shadow-2xl">
              <Image
