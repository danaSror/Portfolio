      ...
      <main className="h-screen bg-white px-10 text-center  dark:bg-gray-800">
        <div className="flex  items-center justify-center h-screen ">
          <section className="flex flex-col gap-10 md:gap-3 sm:gap-3 md:flex-row px-10 lg:mt-64 md:mt-32 sm:mt-96 sm:px-2 ">
            ...
            <div className="md:w-1/2 sm:w-4/5 relative mx-auto lg:mt-1 sm:mb-80 lg:px-10 rounded-3xl sm:rounded-3xl md:rounded-3xl mobile:rounded-3xl shadow-2xl bg-neutral-950 dark:shadow-white dark:shadow-2xl">
              <Image
                src={pic}
                alt=""
                width={650}
